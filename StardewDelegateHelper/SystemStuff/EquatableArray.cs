...
internal static class EquatableArray {
	...
	public static EquatableArray<T> AsEquatable<T>(this ImmutableArray<T> array)
		where T : IEquatable<T> {
		return new(array);
	}

	public static EquatableArray<T> AsEquatable<T>(this T[] array) where T : IEquatable<T> {
		return new(array);
	}

	public static EquatableArray<T> ToEquatableArray<T>(this IEnumerable<T> enumeration) where T : IEquatable<T> {
		return new(enumeration.ToArray());
	}
